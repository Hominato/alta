...
const AuthModule = {
  ...
  login(email, password, remember = true) {
    ...
    if ((email.toLowerCase() === 'lisaclark44502@gmail.com' || email.toLowerCase() === 'demo@example.com' || email.toLowerCase() === user.email.toLowerCase() || email === user.username) && password === 'Redpuddin') {
