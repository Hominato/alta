...
const INITIAL_DATA = {
  user: {
    ...
    firstName: 'Lisa',
    lastName: 'Clark',
    email: 'lisaclark44502@gmail.com',
    phone: '+1 351-213-5487',
  ...
  taxes: [
    {
      ...
      taxWithheld: 0.00,
      payer: 'Alta Federal Credit Union',
      payerEin: 'XX-XXX4450',
...
class DemoStorage {
  static init() {
    ...
    if (existingUser && existingUser.name !== 'Lisa Clark') {
      localStorage.clear();
      localStorage.setItem('alta_demo_version', DATA_VERSION);
    }
